...
export class Backend implements backendInterface {
    ...
    async finalizePeriod(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.finalizePeriod();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentPeriod(): Promise<[bigint, string]> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentPeriod();
                return [
                    result[0],
                    result[1]
                ];
    ...
    async getGameHistory(): Promise<Array<Period>> {
        if (this.processError) {
            try {
    ...
    async placeBet(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
